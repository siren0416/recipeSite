	...
	<div class="register_box">		
	 <div class="container"><!-- 좌우측의 공간 확보 -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <small>
                    <a href="loginpage">로그인</a> | <a href="register">회원가입</a>
                    <br>
                    <br>
                    </small>
                </div>
            ...
            <form id="insertReg" class="form-horizontal" role="form" method="post" action="insertReg">
                ...
                <div class="form-group" id="div_id">
                    <label for="input_id" class="col-lg-2 control-label">아이디</label>
                    <div class="div_input">
                        <input type="text" class="form-control onlyAlphabetAndNumber" id="m_id" name="m_id" data-rule-required="true" placeholder="30자 이내 알파벳" maxlength="30">
                    </div>
                </div>
...
<!--                 <div class="form-group" id="divPasswordCheck">
                ...
                <div class="form-group" id="div_name">
                    <label for="inputName" class="label">이름</label>
                    <div class="div_input">
                ...
                <br>
                <div class="form-group">
                    <div class="col-lg-offset-2 div_input">
